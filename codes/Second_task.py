...
if __name__ == '__main__':
    ...
    train_strong_seqs = read_fasta(
        '/home/iEnhancer-DS/data/layer2/train_strong_enhancers.fa')
    train_weak_seqs = read_fasta(
        '/home/iEnhancer-DS/data/layer2/train_weak_enhancers.fa')
    ...
    test_strong_seqs = read_fasta(
        '/home/iEnhancer-DS/data/layer2/test_strong_enhancers.fa')
    test_weak_seqs = read_fasta(
        '/home/iEnhancer-DS/data/layer2/test_weak_enhancers.fa')
    ...
    for k in range(10):
        ...
        for fold_count, (train_index, val_index) in enumerate(k_fold.split(train)):
            ...
            with open('/home/iEnhancer-DS/two_log_history.txt', 'w') as f:
            ...
            model.save('/home/iEnhancer-DS/models/two/two_enhancer_model_' + str(
                fold_count) + '.h5')

            del model

            model = load_model(
                '/home/iEnhancer-DS/models/two/two_enhancer_model_' + str(
                    fold_count) + '.h5')
    ...
    plt.savefig('/home/iEnhancer-DS/images/ROC_Curve_of_Second_Layer.jpg',
